...
class WA_Modules_Base_Crypt_CustomAES
{
    ...
    private $dt2;
    private $dt3;
    private $enbuffer = array('encrypted' => '', 'xor' => '');
    private $debuffer = array('ciphertext' => '');
    ...
    public function __construct(array $config)
    {
        ...
        $this->key = $config['salt'] . $config['password'];
    ...
    private function ___encryptBlock($in)
    {
        $state = array();
